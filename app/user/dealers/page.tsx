...
export default function SearchDealers() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    // Select first dealer by default on new search to populate details
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-black text-white">Certified Scrap Dealers</h2>
          <p className="text-xs text-gray-400 mt-1 uppercase tracking-wider font-semibold">India's Smartest Certified Recycling Network</p>
        </div>
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-black text-white uppercase tracking-wider">All Certified E-Waste Dealers Near {activeSearch}</h3>
            ...
            return (
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    <span className="text-[9px] bg-slate-950 text-emerald-400 border border-emerald-500/10 px-2 py-0.5 rounded font-mono font-bold uppercase">
                      Certified Recycler
                    </span>
                    <h4 className="text-lg font-black text-white mt-2 leading-tight">
                      {dealer.businessName}
                    </h4>
                    <p className="text-[11px] text-gray-500 font-semibold mt-1">Owner: {dealer.ownerName}</p>
                  </div>
                ...
                <div className="mt-4 text-xs text-gray-300 space-y-2 border-t border-white/5 pt-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <div className="font-semibold text-gray-200">{dealer.distance} away</div>
                      <div className="text-gray-400 text-[11px] mt-0.5">{dealer.address}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 flex flex-wrap gap-1.5">
                  {dealer.services.slice(0, 3).map((serv, idx) => (
